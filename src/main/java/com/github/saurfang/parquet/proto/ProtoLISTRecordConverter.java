 ...
 * It delegates conversion of inner fields to {@link ProtoLISTMessageConverter} class using inheritance.
...
public class ProtoLISTRecordConverter<T extends MessageOrBuilder> extends ProtoLISTMessageConverter {
    ...
    public ProtoLISTRecordConverter(Class<? extends Message> protoclass, MessageType parquetSchema) {
        super(new SkipParentValueContainer(), protoclass, parquetSchema);
        reusedBuilder = getBuilder();
    }

    public ProtoLISTRecordConverter(Message.Builder builder, MessageType parquetSchema) {
